...
def pipeline(transductive = True, verbose=2, logger=None, **kwargs):
    ...
    # model.saint(g, y, split, transductive, verbose, y_test, logger)

    model.evaluate(g, np.arange(TRAIN_SIZE, CELL_SIZE), y_test)

parser = argparse.ArgumentParser()
parser.add_argument('-prefix', '--prefix', default='dance_openproblems_bmmc_rna2adt_test')
parser.add_argument('-t', '--subtask', default='openproblems_bmmc_cite_phase2_rna')
parser.add_argument('-d', '--data_folder', default='../../../single_cell/data/public/phase-private-data/predict_modality/')
